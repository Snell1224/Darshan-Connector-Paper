...
\RED{Explain the structure of the paper. Can do this when it's mostly complete}
...
\RED{\begin{itemize}
    \item Address current I/O performance analysis and implications (i.e. refer to Emily's SC21 presentation)
...
\begin{itemize}
    ...
    \subitem Figure out what type of analyses address this correlation. Reach out to Emily and Ana (possibly) about this. 
