...
\begin{table}[h]
    ...
    \begin{subtable}[h]{0.5\textwidth}
        ...
        \multicolumn{1}{|c|}{Arguments}   & \multicolumn{4}{c|}{Pfam-A.seed}                          \\ \hline
        \multicolumn{5}{|c|}{Average Runtime (s)}                                                     \\ \hline
